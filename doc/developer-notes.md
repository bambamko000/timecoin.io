...
TIMECCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as TIMECCoin Core, where everyone uses
...
pay attention to for reviewers of TIMECCoin Core code.

General TIMECCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: TIMECCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
