...
### Send 10000 TIMEC to New Addresses

Send exactly 10000 TIMEC to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 10000 TIMEC.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 10000 TIMEC on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the time github repo](https://github.com/timepay/time/blob/master/doc/masternode_conf.md)
...
## Update time.conf on server

If you generated a new masternode private key, you will need to update the remote `time.conf` files.
...
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `time.conf` file.
...
Search your Masternodes on https://timeninja.pl/masternodes.html
