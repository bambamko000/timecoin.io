...
This mechanism has been integrated into Bitcore-Node-TIMECCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/timepay/insight-api-time#web-socket-api](https://github.com/timepay/insight-api-time#web-socket-api)
* API: [https://github.com/timepay/insight-api-time#instantsend-transactions](https://github.com/timepay/insight-api-time#instantsend-transactions)
...
By default, the TIMECCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TIMECCoin Core daemon:
