TIMECoin Core version 0.12.2.2
==========================
...
To fix this issue in TIMECoin Core however, we had to backport a lot of other
...
it should be possible to compile TIMECoin Core with `--disable-wallet` option now.
...
- [`952383e16`](https://github.com/timepay/time/commit/952383e16) Backport #7933: Fix OOM when deserializing UTXO entries with invalid length
...
- [`9ad56fe18`](https://github.com/timepay/time/commit/9ad56fe18) TIMECoin related fixes for per-utxo DB
...
- [`8780c762e`](https://github.com/timepay/time/commit/8780c762e) Backport #10985: Add undocumented -forcecompactdb to force LevelDB compactions
...
### Network/Sync:
- [`5d58dd90c`](https://github.com/timepay/time/commit/5d58dd90c) Make sure to clear setAskFor in TIMECoin submodules (#1730)
