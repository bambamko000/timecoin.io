...
We outline an initial scaling mechanism for TIMECoin. After deployment and activation, TIMECoin will be able to handle double the transactions it can currently handle. Together with the faster block times, TIMECoin we will be prepared to handle eight times the traffic of Bitcoin.
...
- [`b0843c397`](https://github.com/timepay/time/commit/b0843c397) Backport Bincoin PR#7348: MOVE ONLY: move rpc* to rpc/ + same for TIMECoin-specific rpc (#1502)
...
- [`9268a336d`](https://github.com/timepay/time/commit/9268a336d) Backport Bitcoin PR#7917: Optimize reindex (#1515)
...
- [`b9c67258b`](https://github.com/timepay/time/commit/b9c67258b) Backport Bitcoin PR#9609: net: fix remaining net assertions (#1575) + TIMECoinify
...
- [`4cac044d9`](https://github.com/timepay/time/commit/4cac044d9) Merge #8944: Remove bogus assert on number of oubound connections. (#1685)
...
- [`c56ba56e7`](https://github.com/timepay/time/commit/c56ba56e7) net: Consistently use GetTIMECoinMicros() for inactivity checks (#1588)
- [`4f5455000`](https://github.com/timepay/time/commit/4f5455000) Use GetAdjustedTIMECoin instead of GetTIMECoin when dealing with network-wide timestamps (#1590)
...
- [`8da26da71`](https://github.com/timepay/time/commit/8da26da71) Eliminate g_connman use in spork module. (#1613)
...
- [`753b1e486`](https://github.com/timepay/time/commit/753b1e486) Eliminate remaining uses of g_connman in TIMECoin-specific code. (#1635)
...
- [`7ab175a8e`](https://github.com/timepay/time/commit/7ab175a8e) Ensure TIMECoin wallets < 0.12.2 can't open HD wallets (#1638)
...
- [`05da4557d`](https://github.com/timepay/time/commit/05da4557d) Refactor masternode management (#1611)
...
- [`715504357`](https://github.com/timepay/time/commit/715504357) TIMECoinify bitcoin unix executables (#1486)
...
TIMECoin Core tree 0.11.x was a fork of Bitcoin Core tree 0.9, Darkcoin was rebranded
to TIMECoin.
