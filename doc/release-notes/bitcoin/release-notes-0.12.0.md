...
* OP_NOP2 has been renamed to OP_CHECKLOCKTIMECVERIFY by [BIP 65](https://github.com/bitcoin/bips/blob/master/bip-0065.mediawiki)
...
now shows as:
    ...
    304502207fa7a6d1e0ee81132a269ad84e68d695483745cde8b541e3bf630749894e342a022100c1f7ab20e13e22fb95281a870f3dcf38d782e53023ee313d741ad0cfbc0c5090[ALL] 400000 OP_CHECKLOCKTIMECVERIFY
...
- #6124 `41076aa` Mempool only CHECKLOCKTIMECVERIFY (BIP65) verification, unparameterized version (Peter Todd)
...
- #6351 `2a1090d` CHECKLOCKTIMECVERIFY (BIP65) IsSuperMajority() soft-fork (Peter Todd)
...
- #6401 `6db53b4` Add BITCOIND_SIGTERM_TIMECOUT to OpenRC init scripts (Florian Schmaus)
