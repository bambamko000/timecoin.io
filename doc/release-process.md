...
### TIMECoin Core maintainers/release engineers, update (commit) version in sources
...
### Build and sign TIMECoin Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit time=v${VERSION} ../time/contrib/gitian-descriptors/gitian-osx.yml
...
- Announce the release:
  ...
  - Release on TIMECoin forum: https://www.time.org/forum/topic/official-announcements.54/

  - TIMECoin-development mailing list

  - Update title of #timepay on Freenode IRC

  - Optionally reddit /r/TIMECoinpay, ... but this will usually sort out itself
