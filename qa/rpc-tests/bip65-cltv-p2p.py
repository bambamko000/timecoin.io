...
from test_framework.script import CScript, OP_1NEGATE, OP_CHECKLOCKTIMECVERIFY, OP_DROP
...
def cltv_invalidate(tx):
    ...
    '''
    tx.vin[0].scriptSig = CScript([OP_1NEGATE, OP_CHECKLOCKTIMECVERIFY, OP_DROP] +
                                  list(CScript(tx.vin[0].scriptSig)))

'''
This test is meant to exercise BIP65 (CHECKLOCKTIMECVERIFY)
