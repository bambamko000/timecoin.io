...
class BIP68_112_113Test(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        ### Version 2 txs ###
        bip68success_txs = []
        # All txs with SEQUENCE_LOCKTIMEC_DISABLE_FLAG set pass
        for b25 in xrange(2):
            for b22 in xrange(2):
                for b18 in xrange(2):
        ...
        # If SEQUENCE_LOCKTIMEC_DISABLE_FLAG is set in argument to OP_CSV, version 1 txs should still pass
        success_txs = []
        for b25 in xrange(2):
            for b22 in xrange(2):
                for b18 in xrange(2):
        ...
        # If SEQUENCE_LOCKTIMEC_DISABLE_FLAG is unset in argument to OP_CSV, version 1 txs should now fail
        fail_txs = []
        ...
        # If SEQUENCE_LOCKTIMEC_DISABLE_FLAG is set in argument to OP_CSV, version 2 txs should pass (all sequence locks are met)
        success_txs = []
        for b25 in xrange(2):
            for b22 in xrange(2):
                for b18 in xrange(2):
        ...
        ## SEQUENCE_LOCKTIMEC_DISABLE_FLAG is unset in argument to OP_CSV for all remaining txs ##
        ...
        # If SEQUENCE_LOCKTIMEC_DISABLE_FLAG is set in nSequence, tx should fail
        fail_txs = []
        for b25 in xrange(2):
            for b22 in xrange(2):
                for b18 in xrange(2):
