...
#
# NodeConn: an object which manages p2p connectivity to a time node
...
# Objects that map to timed objects, which can be serialized/deserialized
...
class CBlockHeader(object):
    ...
    def calc_sha256(self):
        if self.sha256 is None:
            ...
            self.hash = encode(timehash(r)[::-1], 'hex_codec').decode('ascii')
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in timed indicates these should be deserialized as blocks
