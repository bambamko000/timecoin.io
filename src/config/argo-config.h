/* src/config/time-config.h.  Generated from time-config.h.in by configure.  */
/* src/config/time-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TIMEC_CONFIG_H

#define TIMEC_CONFIG_H
