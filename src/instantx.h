...
static const int INSTANTSEND_LOCK_TIMECOUT_SECONDS   = 15;
// For how long we are going to keep invalid votes and votes for failed lock attempts,
// must be greater than INSTANTSEND_LOCK_TIMECOUT_SECONDS
static const int INSTANTSEND_FAILED_TIMECOUT_SECONDS = 60;
