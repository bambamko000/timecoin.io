...
public:
     ...
     * relative lock-time. */
    static const uint32_t SEQUENCE_LOCKTIMEC_DISABLE_FLAG = (1 << 31);

    /* If CTxIn::nSequence encodes a relative lock-time and this flag
     * is set, the relative lock-time has units of 512 seconds,
     * otherwise it specifies blocks with a granularity of 1. */
    static const uint32_t SEQUENCE_LOCKTIMEC_TYPE_FLAG = (1 << 22);

    /* If CTxIn::nSequence encodes a relative lock-time, this mask is
     * applied to extract that lock-time from the sequence field. */
    static const uint32_t SEQUENCE_LOCKTIMEC_MASK = 0x0000ffff;
     ...
     * 9 bits. */
    static const int SEQUENCE_LOCKTIMEC_GRANULARITY = 9;
