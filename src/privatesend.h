...
// timeouts
static const int PRIVATESEND_AUTO_TIMECOUT_MIN       = 5;
static const int PRIVATESEND_AUTO_TIMECOUT_MAX       = 15;
static const int PRIVATESEND_QUEUE_TIMECOUT          = 30;
static const int PRIVATESEND_SIGNING_TIMECOUT        = 15;
