    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("TIMECoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About TIMECoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TIMECoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TIMECoin Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the TIMECoin Core help message to get a list with possible TIMECoin Core command-line options"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        modalOverlay->setKnownBestHeight(clientModel->getHeaderTipHeight(), QDateTime::fromTime_t(clientModel->getHeaderTipTIMECCoin()));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("TIMECoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    int64_t headersTipTIMECCoin = clientModel->getHeaderTipTIMECCoin();
    int headersTipHeight = clientModel->getHeaderTipHeight();
    int estHeadersLeft = (GetTIMECCoin() - headersTipTIMECCoin) / Params().GetConsensus().nPowTargetSpacing;
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    {
        QString timeBehindText = GUIUtil::formatNiceTIMECCoinOffset(secs);
...
{
    QString strTitle = tr("TIMECoin Core"); // default title
