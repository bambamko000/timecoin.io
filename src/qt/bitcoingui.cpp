...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        modalOverlay->setKnownBestHeight(clientModel->getHeaderTipHeight(), QDateTime::fromTime_t(clientModel->getHeaderTipTIMECoin()));
...
{
    int64_t headersTipTIMECoin = clientModel->getHeaderTipTIMECoin();
    int headersTipHeight = clientModel->getHeaderTipHeight();
    int estHeadersLeft = (GetTIMECoin() - headersTipTIMECoin) / Params().GetConsensus().nPowTargetSpacing;
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    {
        QString timeBehindText = GUIUtil::formatNiceTIMECoinOffset(secs);
