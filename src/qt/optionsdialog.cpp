    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TIMEC-light"), QVariant("light"));
    ui->theme->addItem(QString("TIMEC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("TIMEC-green"), QVariant("drkblue"));
    ui->theme->addItem(QString("TIMEC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TIMEC-traditional"), QVariant("trad"));
