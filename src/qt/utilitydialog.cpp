    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("TIMECoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About TIMECoin Core"));
...
All the TIMECoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("TIMECoin Core is shutting down...") + "<br /><br />" +
