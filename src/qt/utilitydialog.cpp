    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("TIMECCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About TIMECCoin Core"));
...
All the TIMECCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TIMEC, 0.1 TIMEC, 1 TIMEC and 10 TIMEC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://timepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://timepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("TIMECCoin Core is shutting down...") + "<br /><br />" +
