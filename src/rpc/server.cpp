...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "time",               "gobject",                &gobject,                true  },
    { "time",               "getgovernanceinfo",      &getgovernanceinfo,      true  },
    { "time",               "getsuperblockbudget",    &getsuperblockbudget,    true  },
    { "time",               "voteraw",                &voteraw,                true  },
    { "time",               "mnsync",                 &mnsync,                 true  },
    { "time",               "spork",                  &spork,                  true  },
    { "time",               "getpoolinfo",            &getpoolinfo,            true  },
    { "time",               "sentinelping",           &sentinelping,           true  },
#ifdef ENABLE_WALLET
    { "time",               "privatesend",            &privatesend,            false },
