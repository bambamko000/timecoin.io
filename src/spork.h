...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 10000;        // 10000 TIMEC
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 1520077577;// Needed to be turned on
