...
//     int64_t nLastRetargetTIMECCoin = 1231006505; // Block #0
//     CBlockIndex pindexLast;
//     pindexLast.nHeight = 2015;
//     pindexLast.nTIMECCoin = 1233061996;  // Block #2015
//     pindexLast.nBits = 0x1d00ffff;
//     BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTIMECCoin, params), 0x1d00ffff);
// }
...
//     int64_t nLastRetargetTIMECCoin = 1279008237; // Block #66528
//     CBlockIndex pindexLast;
//     pindexLast.nHeight = 68543;
//     pindexLast.nTIMECCoin = 1279297671;  // Block #68543
//     pindexLast.nBits = 0x1c05a3f4;
//     BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTIMECCoin, params), 0x1c0168fd);
// }
...
//     int64_t nLastRetargetTIMECCoin = 1263163443; // NOTE: Not an actual block time
//     CBlockIndex pindexLast;
//     pindexLast.nHeight = 46367;
//     pindexLast.nTIMECCoin = 1269211443;  // Block #46367
//     pindexLast.nBits = 0x1c387f6f;
//     BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTIMECCoin, params), 0x1d00e1fd);
// }

BOOST_AUTO_TEST_CASE(GetBlockProofEquivalentTIMECCoin_test)
{
    SelectParams(CBaseChainParams::MAIN);
    const Consensus::Params& params = Params().GetConsensus();
    ...
    for (int i = 0; i < 10000; i++) {
        ...
        blocks[i].nHeight = i;
        blocks[i].nTIMECCoin = 1269211443 + i * params.nPowTargetSpacing;
    ...
    for (int j = 0; j < 1000; j++) {
        ...
        int64_t tdiff = GetBlockProofEquivalentTIMECCoin(*p1, *p2, *p3, params);
        BOOST_CHECK_EQUAL(tdiff, p1->GetBlockTIMECCoin() - p2->GetBlockTIMECCoin());
    }
}
